...
export interface ProjectChangeEvent {
  ...
  entity: 'project' | 'todo' | 'session' | 'knowledge' | 'changelog' | 'milestone' | 'manual' | 'research' | 'research_session' | 'notification' | 'environment' | 'secret' | 'schema' | 'dependency' | 'feature' | 'soul' | 'commit' | 'recurring-task' | 'snippet' | 'attachment' | 'log' | 'release' | 'chat' | 'workspace' | 'customer-project' | 'contact' | 'customer' | 'healthcheck' | 'doc-update-proposal' | 'knowledge-graph' | 'oracle' | 'ssh-connection' | 'ssh-audit' | 'question';
