...
import { api, ApiKeyInfo, ChatConfig, ChatEndpoint, ChatProvider, UserLlmConfig, LlmMode, WorkflowAgentConfig, WorkflowAgentProvider } from '../api/client';
...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    if (tab === 'workflowAgent') loadWorkflowAgentConfig();
  }, [tab, loadApiKeys, loadChatConfig, loadLlmConfig, loadWorkflowAgentConfig]);
  ...
  const tabs: { key: SettingsTab; label: string; group?: string; adminOnly?: boolean }[] = [
    ...
    { key: 'workflowAgent', label: t('settings.tabWorkflowAgent'), group: t('settings.groupAdmin'), adminOnly: true },
